...
delib.module {
  ...
  myconfig.ifEnabled.services.postgresql = {
    ...
    initialScripts = [
      ''
         CREATE ROLE deshiro_api WITH LOGIN PASSWORD '${decryptSecret "infras/deshiro/postgresql/passwords/deshiro_api"}';
         CREATE ROLE deshiro_bot WITH LOGIN PASSWORD '${decryptSecret "infras/deshiro/postgresql/passwords/deshiro_bot"}';
