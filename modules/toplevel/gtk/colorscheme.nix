...
delib.module {
  ...
  home.ifEnabled.xdg.configFile = with colorscheme; let
    css = ''
      ...
      @define-color headerbar_border_color rgba(${base01.rgb}, 0.7);
      ...
      NautilusWindow * { }; // BLACKMAGIC without this, the style does not work in many programs
    '';
  in {
