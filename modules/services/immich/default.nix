...
delib.module {
  ...
  nixos.ifEnabled = {
    ...
    services.immich = {
      ...
      #     immich-machine-learning = pkgs.immich-machine-learning.overrideAttrs {
      #       postPatch = ''
      ...
      #       mkdir node_modules
      #       ln -s ${pkgs.node-addon-api} node_modules/node-addon-api

      #       ${pkgs.lib.getExe pkgs.nodejs} install/check
      ...
      #       makeWrapper ${pkgs.lib.getExe pkgs.nodejs} $out/bin/admin-cli --add-flags $out/dist/main --add-flags cli
      #       makeWrapper ${pkgs.lib.getExe pkgs.nodejs} $out/bin/server --add-flags $out/dist/main --chdir $out \
