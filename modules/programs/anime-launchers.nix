...
delib.module {
  ...
  myconfig.ifEnabled =
    { cfg, ... }:
    {
      ...
      programs.librewolf.bookmarks =
        lib.optional cfg.enableAnimeGameLauncher {
          name = "Genshin";
          bookmarks = [
            {
              name = "тейват";
            ...
            }
            {
              ...
              url =
                ...
                in
                "https://act.hoyolab.com/ys/app/interactive-map/index.html?lang=ru-ru#/map/9?shown_types=${shown_types}&center=-66.00,-233.00&zoom=0.00";
            }
            {
              name = "молитвы";
        ...
        ++ lib.optional cfg.enableSleepyLauncher {
          name = "Zenless";
          bookmarks = [
            {
              name = "отметки";
        ...
        ++ lib.optional cfg.enableHonkersRailwayLauncher {
          name = "Honkai";
          bookmarks = [
            {
              name = "отметки";
